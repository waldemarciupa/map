...
const Map = () => {
    ...
    const [voivodship, setVoivodship] = useState('');
    const [slidePosition, setSlidePosition] = useState(0);
    const [cities] = useState(db);
    const [currentCities, setCurrentCities] = useState([]);
    const [showButtonPrev, setShowButtonPrev] = useState(true);
    const [showButtonNext, setShowButtonNext] = useState(true);

    const showHideButtonPrev = showButtonPrev ? "prev" : "prev display-none";
    const showHideButtonNext = showButtonNext ? "next" : "next display-none";

    function filteredCities(wordToCompare) {
        return function (element) {
            return element.voivodship === wordToCompare;
        }
    }

    const prevSlide = () => {
        slidePosition === 0 ? setSlidePosition(-100 * (currentCities.length - 1)) : setSlidePosition(slidePosition + 100);
    }

    const nextSlide = () => {
        slidePosition === -100 * (currentCities.length - 1) ? setSlidePosition(0) : setSlidePosition(slidePosition - 100);
    }
    ...
    const handleClick = (event, showModal) => {
        setVoivodship(event.target.id);
        setCurrentCities(cities.filter(filteredCities(event.target.id)));
        setModalOpen(true);
    }

    useEffect(() => {
        (slidePosition === -100 * (currentCities.length - 1)) ? setShowButtonNext(false) : setShowButtonNext(true);
        slidePosition === 0 ? setShowButtonPrev(false) : setShowButtonPrev(true);
    }, [slidePosition])

    return (
        <div className="mapContainer">
            <Modal show={modalOpen} handleClose={hideModal} >
                <button onClick={prevSlide} className={showHideButtonPrev} aria-label="Previous slide">
                    <i className="fas fa-chevron-left"></i>
                </button>
                {
                    currentCities.map((e, i) => {
                        return (
                            <div key={i} className="card-container" style={{ transform: `translateX(${slidePosition}%)` }}>
                                <div className="card" >
                                    <div className="card-img">
                                        <img src={e.img} alt={e.city} />
                                    </div>
                                    <div className="card-text">
                                        <p className="card-title">{e.city}</p>
                                        <p className="card-voivodship">{voivodship}</p>
                                    </div>
                                    <div className="card-link">
                                        <a href={e.link} target="_blank" rel="noopener noreferrer" >Wikipedia</a>
                                    </div>
                                </div>
                            </div>
                        )
                ...
                <button onClick={nextSlide} className={showHideButtonNext} aria-label="Next slide">
            ...
            <svg
                ...
                <a onClick={handleClick} xlinkTitle="warmińsko-mazurskie">
                    <path id="warmińsko-mazurskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="pomorskie">
                    <path id="pomorskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="dolnośląskie">
                    <path id="dolnośląskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="zachodniopomorskie">
                    <path id="zachodniopomorskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="lubuskie">
                    <path id="lubuskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="wielkopolskie">
                    <path id="wielkopolskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="kujawsko-pomorskie">
                    <path id="kujawsko-pomorskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="śląskie">
                    <path id="śląskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="łódzkie">
                    <path id="łódzkie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="mazowieckie">
                    <path className="voivodship" id="mazowieckie"
                ...
                <a onClick={handleClick} xlinkTitle="świętokrzyskie">
                    <path id="świętokrzyskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="podlaskie">
                    <path id="podlaskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="lubelskie">
                    <path id="lubelskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="podkarpackie">
                    <path id="podkarpackie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="opolskie">
                    <path id="opolskie" className="voivodship"
                ...
                <a onClick={handleClick} xlinkTitle="małopolskie">
                    <path id="małopolskie" className="voivodship"
